\connect PatientData_db

-- Creation of product table
CREATE TABLE IF NOT EXISTS PatientData_db.product (
...
CREATE TABLE IF NOT EXISTS PatientData_db.country (
...
CREATE TABLE IF NOT EXISTS PatientData_db.city (
...
CREATE TABLE IF NOT EXISTS PatientData_db.store (
...
CREATE TABLE IF NOT EXISTS PatientData_db.users (
...
CREATE TABLE IF NOT EXISTS PatientData_db.status_name (
...
CREATE TABLE IF NOT EXISTS PatientData_db.sale (
...
CREATE TABLE IF NOT EXISTS PatientData_db.order_status (
